...
sh ff claps on the platform. occasionally fall through the platform with a
landing fair.
...
dash in -> backflip
dash back -> scuttle turnaround -> dtile
dash in -> fh -> fadeback
run up shield -> jump back
fh in -> wavedash back on platform
